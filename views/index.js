                        ...
                        postsThumbnails +=
                            `
                                <div class=" col-12 col-sm-6 col-md-4 col-lg-3">
                                    ...
                                    ${post.image ? `<img class="card-img-top limitHeight" src="${post.image}">` : "<div class='bg-dark text-light d-flex justify-content-center align-items-center' style='height:200px'>no image</div>"}
                                    <div class="card-body">
                                        <date>${$.date(post.date)}</date>
                                        <h5 class="card-title">
                                        ${post.title.rendered}
